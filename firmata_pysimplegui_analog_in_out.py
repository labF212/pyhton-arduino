...
layout = [
            ...
            [sg.ProgressBar(100, orientation='h', size=(50,12), bar_color="grey", key='progressbar_AI1',expand_x=True)],
            [sg.Text('Potenciómetro AI5:'),
            sg.Text('None',expand_x=True,key='-TEXTAI5-',justification='center',auto_size_text=True)],
            [sg.ProgressBar(100, orientation='h', size=(50,12), bar_color="grey", key='progressbar_AI5',expand_x=True)],
